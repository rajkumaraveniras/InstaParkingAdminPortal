...
namespace InstaParking.Controllers
{
    public class RevenueReportsController : Controller
    {
        ...
        public ActionResult StationReportPDFDownload(string GrandTotal, string SelectedItems)
        {
            try
            {
                ...
                string filename = GenerateReportNew(dt, GrandTotal, selectstation, selectLot, selectVehicle, FDate, TDate, TotalCash, TotalEPay,TotalOperatorIn,TotalPassesIn,TotalAppIn,TotalCallIn,TotalOut,TotalFOC,TotalClamps);
        ...
        public ActionResult StationReportExcelDownload(string GrandTotal, string SelectedItems)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    using (XLWorkbook wb = new XLWorkbook())
                    {
                        ...
                        wb.Worksheets.Worksheet(0).Cell(6, 5).Value = "App In";
                        ...
                        wb.Worksheets.Worksheet(0).Cell(6, 11).Value = "EPay";
                        ...
                        wb.Worksheets.Worksheet(0).Cell(6, 12).Value = "Amount";
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            // wb.Worksheets.Worksheet(0).Cell(row, column_num + 1).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left;
                            ...
                            //wb.Worksheets.Worksheet(0).Cell(row, column_num + 2).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left;
                            ...
                            //wb.Worksheets.Worksheet(0).Cell(row, column_num + 3).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left;
                            ...
                            wb.Worksheets.Worksheet(0).Cell(row, column_num + 5).Value = Convert.ToString(dt.Rows[i]["AppIn"]);
                            ...
                            //  wb.Worksheets.Worksheet(0).Cell(row, column_num + 8).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Left;

                            wb.Worksheets.Worksheet(0).Cell(row, column_num + 9).Value = Convert.ToString(dt.Rows[i]["Clamps"]);
                            wb.Worksheets.Worksheet(0).Cell(row, column_num + 9).Style.Font.FontSize = 11;

                            wb.Worksheets.Worksheet(0).Cell(row, column_num + 10).Value = Convert.ToString(dt.Rows[i]["Cash"]);
                            ...
                            wb.Worksheets.Worksheet(0).Cell(row, column_num + 11).Value = Convert.ToString(dt.Rows[i]["EPay"]);
                            ...
                            wb.Worksheets.Worksheet(0).Cell(row, column_num + 12).Value = Convert.ToString(dt.Rows[i]["Amount"]);
                        ...
                        wb.Worksheets.Worksheet(0).Cell(row, 5).Value = TotalAppIn;
                        ...
                        wb.Worksheets.Worksheet(0).Cell(row, 7).Value = TotalOut;
                        ...
                        wb.Worksheets.Worksheet(0).Cell(row, 11).Value = TotalEPay;
                        wb.Worksheets.Worksheet(0).Cell(row, 11).Style.Font.Bold = true;
                        wb.Worksheets.Worksheet(0).Cell(row, 11).Style.Font.FontSize = 11;
                        wb.Worksheets.Worksheet(0).Cell(row, 11).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right;

                        wb.Worksheets.Worksheet(0).Cell(row, 12).Value = GrandTotal;
                        wb.Worksheets.Worksheet(0).Cell(row, 12).Style.Font.Bold = true;
                        wb.Worksheets.Worksheet(0).Cell(row, 12).Style.Font.FontSize = 11;
                        wb.Worksheets.Worksheet(0).Cell(row, 12).Style.Alignment.Horizontal = XLAlignmentHorizontalValues.Right;
        ...
        public string GenerateReportNew(DataTable dt, string grandTotal, string selectstation, string selectLot, string selectVehicle, string FDate, string TDate, string TotalCash, string TotalEPay, string TotalOperatorIn, string TotalPassesIn, string TotalAppIn, string TotalCallIn, string TotalOut, string TotalFOC, string TotalClamps)
        {
            ...
            //table2.SetWidths(new float[] { 0.2f, 0.1f, 0.09f, 0.08f, 0.08f, 0.07f, 0.07f, 0.07f, 0.07f, 0.09f, 0.09f });
        ...
        public string GenerateReportByPaymentType(DataTable dt, string grandTotal, string selectstation, string selectLot, string selectVehicle, string FDate, string TDate, string OperatorInTotal, string AppInTotal, string CallInTotal)
        {
            ...
            //BaseFont bf_heading1 = BaseFont.CreateFont(BaseFont.TIMES_ROMAN, BaseFont.CP1252, false);
            //iTextSharp.text.Font _bf_heading1 = new iTextSharp.text.Font(bf_heading1, 10f, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.ColorTranslator.FromHtml("#353535")));

            //BaseFont bf_headingbold = BaseFont.CreateFont(BaseFont.TIMES_ROMAN, BaseFont.CP1252, false);
            //iTextSharp.text.Font _bf_headingbold = new iTextSharp.text.Font(bf_headingbold, 10f, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.ColorTranslator.FromHtml("#353535")));

            //BaseFont bf_headingTitle = BaseFont.CreateFont(BaseFont.TIMES_ROMAN, BaseFont.CP1252, false);
            //iTextSharp.text.Font _bf_headingTitle = new iTextSharp.text.Font(bf_headingTitle, 12f, iTextSharp.text.Font.BOLD, BaseColor.BLACK);

            //BaseFont bf_headingboldTable = BaseFont.CreateFont(BaseFont.TIMES_ROMAN, BaseFont.CP1252, false);
            //iTextSharp.text.Font _bf_headingboldTable = new iTextSharp.text.Font(bf_headingboldTable, 10f, iTextSharp.text.Font.BOLD, BaseColor.BLACK);

            //BaseFont bf_headingboldTableNrml = BaseFont.CreateFont(BaseFont.TIMES_ROMAN, BaseFont.CP1252, false);
            //iTextSharp.text.Font _bf_headingboldTableNrml = new iTextSharp.text.Font(bf_headingboldTableNrml, 10f, iTextSharp.text.Font.NORMAL, BaseColor.BLACK);
        ...
        public ActionResult SupervisorReportPDFDownload(string GrandTotal, string SelectedItems)
        {
            try
            {
                ...
                string filename = GenerateReportBySupervisor(dt, GrandTotal, selectSupervisor, selectstation, selectLot, FDate, TDate, TotalClampCash, TotalClampEPay, TotalCheckInsCash, TotalCheckInsEPay, TotalPassesCash, TotalPassesEPay, TotalNFCCash, TotalNFCEPay);
                FileStream sourceFile = null;
        ...
        public string GenerateReportBySupervisor(DataTable dt, string grandTotal, string supervisor, string selectstation, string selectLot, string FDate, string TDate, string TotalClampCash, string TotalClampEPay, string TotalCheckInsCash, string TotalCheckInsEPay, string TotalPassesCash, string TotalPassesEPay, string TotalNFCCash, string TotalNFCEPay)
        {
            ...
            #region Data
            PdfPTable table2 = new PdfPTable(dt.Columns.Count - 8);
            table2.SetWidths(new float[] { 0.21f, 0.17f, 0.18f, 0.18f, 0.21f, 0.21f, 0.14f, 0.14f, 0.14f, 0.14f, 0.17f, 0.17f, 0.16f });
            table2.TotalWidth = doc.PageSize.Width - 40f;
            table2.LockedWidth = true;
            table2.SpacingBefore = 10f;
            // table2.SpacingAfter = 3f;
            ...
            {
                string cellText = Server.HtmlDecode(dt.Columns[i].ColumnName);
                if (cellText != "TotalClampCash" && cellText != "TotalClampEPay" && cellText != "TotalCheckInsCash" && cellText != "TotalCheckInsEPay" && cellText != "TotalPassesCash" && cellText != "TotalPassesEPay" && cellText != "TotalNFCCash" && cellText != "TotalNFCEPay")
                {
                    PdfPCell cell2 = new PdfPCell();
                    if (cellText == "ClampCash" || cellText == "ClampEPay" || cellText == "CheckInsCash" || cellText == "CheckInsEPay" || cellText == "PassesCash" || cellText == "PassesEPay" || cellText == "NFCCash" || cellText == "NFCEPay" || cellText == "Amount")
                    {
            ...
            PdfPTable grandTable = new PdfPTable(dt.Columns.Count - 8);
            grandTable.SetWidths(new float[] { 0.21f, 0.17f, 0.18f, 0.18f, 0.21f, 0.21f, 0.14f, 0.14f, 0.14f, 0.14f, 0.17f, 0.17f, 0.16f });
            grandTable.TotalWidth = doc.PageSize.Width - 40f;
            grandTable.LockedWidth = true;
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    using (XLWorkbook wb = new XLWorkbook())
                    {
                        ...
                        wb.Worksheets.Worksheet(0).Cell(6, 13).Value = "Amount";
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            wb.Worksheets.Worksheet(0).Cell(row, column_num + 13).Value = Convert.ToString(dt.Rows[i]["Amount"]);
                        ...
                        wb.Worksheets.Worksheet(0).Cell(row, 13).Value = GrandTotal;
